...
public class KpiService {
    ...
    public KpiDTO obtenerKpis() {
        ...
        //  (descartado) KPI 1: Tiempo máximo de un libro sin registrar préstamos
        ...
        // KPI 2: % Préstamos atrasados
        Long prestamosAtrasados = prestamoRepository.contarPrestamosAtrasados();
        Long totalPrestamos = prestamoRepository.contarPrestamosActivos();
